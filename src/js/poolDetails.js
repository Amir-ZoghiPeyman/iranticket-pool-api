...
export default async function poolDetails(link) {
  ...
  try {
    ...
    const detailCard = $(`
        <div
          class="p-4 my-3 mx-2 shadow rounded-4 d-md-flex flex-row-reverse justify-content-between align-items-center gap-4 pool-card-lg"
        >
          <div class="w-100 pool-card-img">
            <img
              src="https://iranticket.co/${pool.poolImg[0]?.src}"
              alt="${pool.title}"
              class="rounded-4 object-fit-cover img-fluid w-100"
            />
          </div>

          <div class="mt-3 pool-card-content">
            ...
            <div
              class="mx-2 d-md-flex justify-content-center align-items-center gap-5"
            >
              ...
              <div class="d-flex gap-4">
                ...
                <div>
                  ...
                  <p class="font-size">
                    ${pool.minTime ? pool.minTime : "-"} تا ${pool.maxTime ? pool.maxTime : "-"}
                  </p>
                </div>
              </div>
            </div>
            ...
            <a
              href="#pool-info-section"
              id="scroll-desc"
              class="main-color my-2 d-flex justify-content-center font-size text-decoration-none"
            >
              مشاهده بیشتر
            </a>
          </div>
        ...
        <div class="container my-4">
          <div class="row row-cols-2 row-cols-lg-4 g-3">
            <div class="col d-flex flex-column align-items-center">
              <div class="m-1">
                <i class="bi bi-gift-fill icon-size text-success"></i>
              </div>
            ...
            <div class="col d-flex flex-column align-items-center">
              <div class="m-1">
                <i class="bi bi-printer-fill icon-size text-warning"></i>
              </div>
            ...
            <div class="col d-flex flex-column align-items-center">
              <div class="m-1">
                <i class="bi bi-printer-fill icon-size text-danger"></i>
              </div>
            ...
            <div class="col d-flex flex-column align-items-center">
              <div class="m-1">
                <i class="bi bi-credit-card icon-size text-primary"></i>
              </div>
        ...
        <div class="container my-5" id="pool-info-section">
          ...
          <div class="tab-panel mt-3 font-size d-none" id="features">
            <div class="row">${renderPoolOptions(pool.poolOption)}</div>
          </div>
        </div>
        `);
